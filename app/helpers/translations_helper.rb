module TranslationsHelper
  TRANSLATIONS = {
    ...
    invite_message: { "🇺🇸": "Welcome to Pando. Don't be a stranger—say hello and introduce yourself.", "🇪🇸": "Bienvenido a Pando. No seas un extraño: di hola y preséntate.", "🇫🇷": "Bienvenue sur Pando. Ne soyez pas un étranger: dites bonjour et présentez-vous.", "🇮🇳": "Pando में आपका स्वागत है। अजनबी मत बनो—हैलो कहो और अपना परिचय दो।", "🇩🇪": "Willkommen bei Pando. Sei kein Fremder – sag Hallo und stell dich vor.", "🇧🇷": "Bem-vindo ao Pando. Não seja um estranho - diga olá e se apresente." },
    incompatible_browser_messsage: { "🇺🇸": "Upgrade to a supported web browser. Pando requires a modern web browser. Please use one of the browsers listed below and make sure auto-updates are enabled.", "🇪🇸": "Actualiza a un navegador web compatible. Pando requiere un navegador web moderno. Utiliza uno de los navegadores listados a continuación y asegúrate de que las actualizaciones automáticas estén habilitadas.", "🇫🇷": "Mettez à jour vers un navigateur web pris en charge. Pando nécessite un navigateur web moderne. Veuillez utiliser l'un des navigateurs répertoriés ci-dessous et assurez-vous que les mises à jour automatiques sont activées.", "🇮🇳": "समर्थित वेब ब्राउज़र में अपग्रेड करें। Pando को एक आधुनिक वेब ब्राउज़र की आवश्यकता है। कृपया नीचे सूचीबद्ध ब्राउज़रों में से कोई एक का उपयोग करें और सुनिश्चित करें कि स्वचालित अपडेट्स सक्षम हैं।", "🇩🇪": "Aktualisieren Sie auf einen unterstützten Webbrowser. Pando erfordert einen modernen Webbrowser. Verwenden Sie bitte einen der unten aufgeführten Browser und stellen Sie sicher, dass automatische Updates aktiviert sind.", "🇧🇷": "Atualize para um navegador web compatível. O Pando requer um navegador web moderno. Por favor, use um dos navegadores listados abaixo e certifique-se de que as atualizações automáticas estão habilitadas." },
